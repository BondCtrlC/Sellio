...
const testimonials = [
  {
    ...
    avatar: '👩‍🎨',
    content: 'ขาย Preset และ Template ผ่าน Sellio มาเกือบปี ใช้งานง่ายมาก ลูกค้าชำระผ่าน QR ได้เลย ไม่ต้องมานั่งตอบแชทส่งไฟล์เอง',
    rating: 5
  },
  {
    name: 'ธนกฤต ศรีวิชัย',
  ...
  },
  {
    ...
    avatar: '🎨',
    content: 'เคยลองหลายแพลตฟอร์ม Sellio ใช้ง่ายที่สุด รองรับภาษาไทยเต็มที่ ค่าธรรมเนียมถูก เหมาะกับ Creator ไทยมาก',
    rating: 5
  },
  {
    name: 'วริศรา แก้วมณี',
